...
class KeyValueStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Put = channel.unary_unary(
                '/schoolmcp.kvstore.KeyValueStore/Put',
        ...
        self.Health = channel.unary_unary(
                '/schoolmcp.kvstore.KeyValueStore/Health',
...
def add_KeyValueStoreServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'schoolmcp.kvstore.KeyValueStore', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('schoolmcp.kvstore.KeyValueStore', rpc_method_handlers)
